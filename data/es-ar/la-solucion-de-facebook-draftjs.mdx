...
<ExampleImage height={120} width={320} src={'/assets/posts/001/pre2014.png'} alt={'Mención antigua'} />
...
<ExampleImage width={320} height={80} src={'/assets/posts/001/record.png'} alt={'Record en Draftjs'} />
...
<ExampleImage height={120} width={320} src={'/assets/posts/001/array.png'} alt={'Lista de Records'} />
